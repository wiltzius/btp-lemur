...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.from(alert_link_containers).forEach(function (el) {
	  var order_href = el.attributes["data-order-href"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OrderReopenLink = function (_React$Component) {
	  ...
	  function OrderReopenLink(props) {
	    _classCallCheck(this, OrderReopenLink);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OrderReopenLink).call(this, props));
	  ...
	  _createClass(OrderReopenLink, [{
	    ...
	    value: function triggerAlert() {
	      window.confirm('Do you want to reopen the order?');
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement('a', { onClick: this.triggerAlert });
	    }
	  }]);
