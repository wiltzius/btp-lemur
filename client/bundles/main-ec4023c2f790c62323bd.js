...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InmateSearchProxy = __webpack_require__(1);

	var _InmateSearchProxy2 = _interopRequireDefault(_InmateSearchProxy);

	var _OrderReopenLink = __webpack_require__(161);

	var _OrderReopenLink2 = _interopRequireDefault(_OrderReopenLink);

	var _InmateAddForm = __webpack_require__(182);

	var _InmateAddForm2 = _interopRequireDefault(_InmateAddForm);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InmateSearchProxy = function (_React$Component) {
	  _inherits(InmateSearchProxy, _React$Component);

	  function InmateSearchProxy(props) {
	    _classCallCheck(this, InmateSearchProxy);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InmateSearchProxy).call(this, props));
	  ...
	  _createClass(InmateSearchProxy, [{
	    key: 'oldParoledDate',
	    value: function oldParoledDate() {
	      if (this.state.parole_single) {
	        var today = new Date();
	        var parole_date = new Date(this.state.parole_single);
	    ...
	    value: function componentDidMount() {
	      ...
	      $.get('/lemur/inmate_search_proxy_pk/' + this.props.inmatePk, function (results) {
	        _this2.setState({
	    ...
	    value: function render() {
	      var paroleClasses = (0, _classnames2.default)({
	        'docLabel': true,
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: paroleClasses },
	            'Parole/release date:'
	          ),
	          _react2.default.createElement(
	            'span',
	            { className: 'docValue' },
	            this.state.parole_single
	          )
	        ),
	        _react2.default.createElement(
	          'li',
	  ...
	  return InmateSearchProxy;
	}(_react2.default.Component);

	// bootstrapping / mount the component


	exports.default = InmateSearchProxy;
	var inmate_search_proxy_containers = document.querySelectorAll('.inmateSearchProxyContainer');
	Array.from(inmate_search_proxy_containers).forEach(function (el) {
	  var inmate_pk = el.attributes["data-inmate-id"].value;
	  _reactDom2.default.render(_react2.default.createElement(InmateSearchProxy, { inmatePk: inmate_pk }), el);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactModal = __webpack_require__(162);
	...
	var OrderReopenLink = function (_React$Component) {
	  _inherits(OrderReopenLink, _React$Component);

	  function OrderReopenLink() {
	    _classCallCheck(this, OrderReopenLink);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OrderReopenLink).call(this));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            'We don\'t typically reopen orders.'
	          ),
	          _react2.default.createElement(
	            'button',
	            { onClick: this.navigate, style: { marginRight: '1em' } },
	            'Reopen'
	          ),
	          _react2.default.createElement(
	            'button',
	  ...
	  return OrderReopenLink;
	}(_react2.default.Component);

	exports.default = OrderReopenLink;


	var alert_link_containers = document.querySelectorAll('.orderReopenLink');
	Array.from(alert_link_containers).forEach(function (el) {
	  var order_href = el.attributes["data-order-href"].value;
	  _reactDom2.default.render(_react2.default.createElement(OrderReopenLink, { orderHref: order_href }), el);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InmateAddForm = function (_React$Component) {
	  _inherits(InmateAddForm, _React$Component);

	  function InmateAddForm() {
	    _classCallCheck(this, InmateAddForm);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(InmateAddForm).call(this));
	  ...
	  _createClass(InmateAddForm, [{
	    key: 'handleChange',
	    value: function handleChange(propName, event) {
	    ...
	    value: function submitHandler(event) {
	      event.preventDefault();
	      _axios2.default.post('/lemur/inmate/add', {}).then(function (resp) {});
	    }
	  }, {
	    key: 'submitInmateIdHandler',
	    value: function submitInmateIdHandler(event) {
	      var _this2 = this;

	      event.preventDefault(); // we don't want the form to actually be submitted
	      _axios2.default.get('/lemur/inmate_search_proxy_id/' + this.state.inmate_id).then(function (resp) {
	        console.log(resp.data);
	        _this2.setState(resp.data);
	        _this2.setState({ attemptingInmateId: false });
	      }).catch(function (err) {
	        // TODO
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      if (this.state.attemptingInmateId) {
	        return _react2.default.createElement(
	          'form',
	          { onSubmit: this.submitInmateIdHandler.bind(this) },
	          _react2.default.createElement(
	            'div',
	            { id: 'searchBoxLeft' },
	            _react2.default.createElement(
	              ...
	              'Inmate ID: ',
	              _react2.default.createElement('input', { type: 'text', value: this.state.inmate_id,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'submit', value: 'Find Inmate', onClick: this.submitInmateIdHandler.bind(this) })
	          )
	        );
	      } else {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                { className: 'fieldWrapper' },
	                'First name: ',
	                _react2.default.createElement('input', { type: 'text', value: this.state.first_name,
	                  name: 'first_name',
	              ...
	              _react2.default.createElement(
	                ...
	                { className: 'fieldWrapper' },
	                'Last name: ',
	                _react2.default.createElement('input', { type: 'text', value: this.state.last_name,
	                  name: 'last_name',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'select',
	                  { type: 'text', value: this.state.facility_pk,
	                    name: 'facility',
	                    onChange: this.handleChange.bind(this, 'facility_pk') },
	                  globalFacilityList.map(function (fac) {
	                    return _react2.default.createElement(
	                      'option',
	                      { key: fac.pk, value: fac.pk },
	                      fac.fields.name
	                    );
	                  })
	                ),
	              ...
	              this.state.facility_pk != 1 ? undefined : _react2.default.createElement(
	                'div',
	                { className: 'fieldWrapper', id: 'addressWrapper' },
	                'Address: ',
	                _react2.default.createElement('input', { type: 'text', value: this.state.address,
	                  name: 'address',
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'formfooter' },
	              _react2.default.createElement('input', { type: 'submit', value: 'Add New Record', onClick: this.submitHandler.bind(this) })
	            )
	          )
	        );
	      }
	  ...
	  return InmateAddForm;
	}(_react2.default.Component);

	exports.default = InmateAddForm;


	var container = document.getElementById('inmateAddFormComponent');
	if (container) {
	  _reactDom2.default.render(_react2.default.createElement(InmateAddForm, null), container);
	}
