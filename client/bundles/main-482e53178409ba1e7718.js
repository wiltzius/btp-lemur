...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.from(inmate_search_proxy_containers).forEach(function (el) {
	  ...
	  ReactDOM.render(_react2.default.createElement(InmateSearchProxy, { inmatePk: inmate_pk }), el);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.from(alert_link_containers).forEach(function (el) {
	  ...
	  ReactDOM.render(_react2.default.createElement(OrderReopenLink, { orderHref: order_href }), el);
	});
