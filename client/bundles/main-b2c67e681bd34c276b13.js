...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InmateSearchProxy = __webpack_require__(158);
	...
	try {
	  for (var _iterator = document.querySelectorAll('.inmateSearchProxyContainer')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    var el = _step.value;

	    console.log(el.attributes);
	    _react2.default.render(React.createElement(_InmateSearchProxy2.default, null), el);
	  }
	} catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InmateSearchProxy = function (_React$Component) {
	  ...
	  function InmateSearchProxy() {
	    _classCallCheck(this, InmateSearchProxy);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(InmateSearchProxy).apply(this, arguments));
	  }
