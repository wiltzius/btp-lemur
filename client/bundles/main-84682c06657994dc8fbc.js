...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.from(inmate_search_proxy_containers).forEach(function (el) {
	  var inmate_pk = el.attributes["data-inmate-id"].value;
	  _reactDom2.default.render(React.createElement(_InmateSearchProxy2.default, { inmatePk: inmate_pk }), el);
	});
	...
	Array.from(alert_link_containers).forEach(function (el) {
	  ...
	  _reactDom2.default.render(React.createElement(_OrderReopenLink2.default, { orderHref: order_href }), el);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OrderReopenLink = function (_React$Component) {
	  ...
	  function OrderReopenLink() {
	    ...
	    _this.triggerAlert = _this.triggerAlert.bind(_this);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: this.navigate, style: 'margin-right: 1em;' },
	            'Reopen'
	          ),
	          _react2.default.createElement(
	            'button',
