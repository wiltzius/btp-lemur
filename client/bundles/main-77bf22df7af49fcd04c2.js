...
/***/ function(module, exports, __webpack_require__) {
	...
	for (var i = 0; i < containers.length; i++) {
	  var el = containers[i];
	  console.log(el);
	  _reactDom2.default.render(React.createElement(_InmateSearchProxy2.default, null), el);
	}
	//Array.forEach(, el => {
	//
	//});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.InmateSearchProxy = undefined;
	...
	var InmateSearchProxy = exports.InmateSearchProxy = function (_React$Component) {
