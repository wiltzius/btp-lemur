...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.from(inmate_search_proxy_containers).forEach(function (el) {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(_InmateSearchProxy2.default, { inmatePk: inmate_pk }), el);
	});
	...
	Array.from(alert_link_containers).forEach(function (el) {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(_OrderReopenLink2.default, { orderHref: order_href }), el);
	});
