...
class OrderTest(TestCase):
    ...
    def create_order_1():
        ...
        o1.save()
        # ...with 1 dummy book
        b1 = server.LemurApp.models.book.Book()
        b1.title = "dictionary"
        b1.order = o1
        b1.save()
        return o1
    ...
    def create_order_2(i):
        ...
        o2.save()
        # ...with 1 dummy book
        b2 = server.LemurApp.models.book.Book()
        b2.title = "dictionary"
        b2.order = o2
        b2.full_clean()
        b2.save()
    ...
    def test_order_warnings(self):
        ...
        # Add another book
        b3 = server.LemurApp.models.book.Book()
        b3.order = o2
        b3.title = "dictionary"
        b3.full_clean()
        b3.save()
    ...
    def test_unicode_errors_db(self):
        ...
        book = server.LemurApp.models.book.Book.get_book('8478889019')
        book.order = order
        book.save()
