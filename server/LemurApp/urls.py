...
urlpatterns = patterns('server.LemurApp.views',
    ...
    url(r'^inmate_search_proxy_pk/(?P<pk>\d+)/$', 'inmate_search_proxy_pk', name='inmate-search-proxy-pk'),
    url(r'^inmate_search_proxy_id/(?P<inmate_id>\w+)/$', 'inmate_search_proxy_id', name='inmate-search-proxy-id'),
