...
from .. import forms
from ..lib.search_proxy.federal import federal_search_proxy
from ..lib.search_proxy.il import illinois_search_proxy
from ..lib.search_proxy.ky import kentucky_search_proxy
from ..models import Inmate, Facility
...
def inmate_add_searched(request):
  ...
  return render('LemurApp/inmate_add.html', context_dict, context=RequestContext(request))
